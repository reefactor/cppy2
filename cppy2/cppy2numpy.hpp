/**
 * Use numpy from C++ code via CPython api wrapped in classes
 *
...
#define PY_ARRAY_UNIQUE_SYMBOL PyArray_API__CPPY2_APP_TOKEN
#if !defined(IMCLUDED_FROM_IMPORTNUMPY_CPP)
...
public:
  ...
  NDArray(Type* data, int n) : _ndarray(NULL) {
    copy(data, n);
  }

  NDArray(Type* data, int n1, int n2) : _ndarray(NULL) {
    copy(data, n1, n2);
  }
   ...
   */
  void copy(Type* data, size_t n1, size_t n2) {
    create(n1, n2, false);
